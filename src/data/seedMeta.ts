...
const ARCHETYPES: Record<FormatId, ArchetypeDef[]> = {
  standard: [
    ...
    },
    {
      ...
      metaShare: 12.3,
      description:
        "Current Standard (July 2026) prowess — Slickshot Show-Off, Stormchaser's Talent, Flow State, Eddymurk Crab. No rotated one-drops.",
      mainboard: [
        // Creatures — Goldfish Standard Izzet Prowess staples (Challenge-winning shell)
        c(4, "Slickshot Show-Off"),
        c(3, "Eddymurk Crab"),
        c(2, "Drake Hatcher"),
        c(2, "Colorstorm Stallion"),
        // Enchantments
        c(4, "Stormchaser's Talent"),
        // Cantrips / selection
        c(4, "Sleight of Hand"),
        c(4, "Opt"),
        c(4, "Boomerang Basics"),
        c(3, "Flow State"),
        // Interaction / burn
        c(4, "Burst Lightning"),
        c(2, "Wild Ride"),
        ...
        c(2, "Secret Identity"),
        // Lands (20)
        c(4, "Spirebluff Canal"),
        c(4, "Steam Vents"),
        c(4, "Riverpyre Verge"),
        c(2, "Multiversal Passage"),
        c(4, "Island"),
        c(2, "Mountain"),
      ],
      sideboard: [
        c(3, "Spell Pierce"),
        c(2, "Ghost Vacuum"),
        c(2, "Soul-Guide Lantern"),
        c(2, "Get Out"),
        c(2, "Slagstorm"),
        c(2, "Broadside Barrage"),
        c(1, "Ral, Crackling Wit"),
        c(1, "Annul"),
      ],
    },
    {
    ...
    },
    {
      ...
      metaShare: 8.7,
      description:
        "Namor + Eddymurk Crab + spell density — Standard spells-matter midrange (not legacy prowess one-drops).",
      mainboard: [
        c(4, "Slickshot Show-Off"),
        c(3, "Eddymurk Crab"),
        c(2, "Namor the Sub-Mariner"),
        c(2, "Colorstorm Stallion"),
        c(4, "Stormchaser's Talent"),
        c(4, "Sleight of Hand"),
        c(4, "Opt"),
        c(3, "Boomerang Basics"),
        c(3, "Flow State"),
        c(3, "Burst Lightning"),
        c(2, "Wild Ride"),
        c(2, "Bounce Off"),
  ...
  alchemy: [
    ...
    { name: "Izzet Spells", colors: ["U", "R"], tier: 2, metaShare: 8, description: "Spell-heavy tempo for Alchemy.", mainboard: [c(4, "Slickshot Show-Off"), c(3, "Eddymurk Crab"), c(4, "Stormchaser's Talent"), c(4, "Opt"), c(4, "Sleight of Hand"), c(4, "Burst Lightning"), c(3, "Boomerang Basics"), c(3, "Flow State"), c(2, "Bounce Off"), c(4, "Spirebluff Canal"), c(4, "Steam Vents"), c(3, "Riverpyre Verge"), c(4, "Island"), c(4, "Mountain"), c(2, "Drake Hatcher"), c(2, "Wild Ride"), c(2, "Spell Pierce")] },
    ...
    { name: "Mono-Red", colors: ["R"], tier: 3, metaShare: 6, description: "Linear aggro for Alchemy Bo1.", mainboard: [c(4, "Heartfire Hero"), c(4, "Slickshot Show-Off"), c(4, "Emberheart Challenger"), c(4, "Burst Lightning"), c(4, "Lightning Strike"), c(3, "Screaming Nemesis"), c(20, "Mountain"), c(4, "Rockface Village"), c(3, "Witchstalker Frenzy"), c(3, "Den of the Bugbear"), c(3, "Sleight of Hand"), c(4, "Wild Ride")] },
  ...
  standard_brawl: [
    ...
    { name: "Mono-Red Aggro", colors: ["R"], tier: 2, metaShare: 5, description: "Burn and haste for Standard Brawl (Standard-legal only).", commander: "Screaming Nemesis", mainboard: [c(1, "Heartfire Hero"), c(1, "Slickshot Show-Off"), c(1, "Emberheart Challenger"), c(1, "Play with Fire"), c(1, "Lightning Strike"), c(1, "Burst Lightning"), c(18, "Mountain"), c(1, "Rockface Village"), c(1, "Den of the Bugbear"), c(1, "Witchstalker Frenzy"), c(1, "Sokenzan, Crucible of Defiance"), c(1, "Screaming Nemesis")] },
