...
void main() {
	...
	`}function sm(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ma||l===ya,u=l===Vi||l===Wi;if(c||u){let h=e.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new vl(n)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&s(p)?(t===null&&(t=new vl(n)),h=c?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function rm(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&_s("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function am(n,e,t,i){const s={},r=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const p in d)e.update(d[p],n.ARRAY_BUFFER)}function c(h){const d=[],p=h.index,g=h.attributes.position;let _=0;if(p!==null){const b=p.array;_=p.version;for(let T=0,S=b.length;T<S;T+=3){const A=b[T+0],R=b[T+1],C=b[T+2];d.push(A,R,R,C,C,A)}}else if(g!==void 0){const b=g.array;_=g.version;for(let T=0,S=b.length/3-1;T<S;T+=3){const A=T+0,R=T+1,C=T+2;d.push(A,R,R,C,C,A)}}else return;const m=new(xc(d)?bc:Tc)(d,1);m.version=_;const f=r.get(h);f&&e.remove(f),r.set(h,m)}function u(h){const d=r.get(h);if(d){const p=h.index;p!==null&&d.version<p.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function om(n,e,t){let i;function s(d){i=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,p){n.drawElements(i,p,r,d*a),t.update(p,i,1)}function c(d,p,g){g!==0&&(n.drawElementsInstanced(i,p,r,d*a,g),t.update(p,i,g))}function u(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,i,1)}function h(d,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/a,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,r,d,0,_,0,g);let f=0;for(let b=0;b<g;b++)f+=p[b]*_[b];t.update(f,i,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function lm(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function cm(n,e,t){const i=new WeakMap,s=new Je;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=i.get(o);if(d===void 0||d.count!==h){let y=function(){C.dispose(),i.delete(o),o.removeEventListener("dispose",y)};d!==void 0&&d.texture.dispose();const p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let T=0;p===!0&&(T=1),g===!0&&(T=2),_===!0&&(T=3);let S=o.attributes.position.count*T,A=1;S>e.maxTextureSize&&(A=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const R=new Float32Array(S*A*4*h),C=new Sc(R,S,A,h);C.type=sn,C.needsUpdate=!0;const N=T*4;for(let M=0;M<h;M++){const U=m[M],B=f[M],k=b[M],q=S*A*4*M;for(let W=0;W<U.count;W++){const G=W*N;p===!0&&(s.fromBufferAttribute(U,W),R[q+G+0]=s.x,R[q+G+1]=s.y,R[q+G+2]=s.z,R[q+G+3]=0),g===!0&&(s.fromBufferAttribute(B,W),R[q+G+4]=s.x,R[q+G+5]=s.y,R[q+G+6]=s.z,R[q+G+7]=0),_===!0&&(s.fromBufferAttribute(k,W),R[q+G+8]=s.x,R[q+G+9]=s.y,R[q+G+10]=s.z,R[q+G+11]=k.itemSize===4?s.w:1)}}d={count:h,texture:C,size:new Te(S,A)},i.set(o,d),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let p=0;for(let _=0;_<c.length;_++)p+=c[_];const g=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(n,"morphTargetBaseInfluence",g),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function um(n,e,t,i){let s=new WeakMap;function r(l){const c=i.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return h}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const Fc=new xt,Ml=new yo(1,1),Oc=new Sc,Bc=new Mc,zc=new Rc,yl=[],El=[],Tl=new Float32Array(16),bl=new Float32Array(9),Al=new Float32Array(4);function ji(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=yl[s];if(r===void 0&&(r=new Float32Array(s),yl[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function St(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Mt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function _r(n,e){let t=El[e];t===void 0&&(t=new Int32Array(e),El[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function hm(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function dm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;n.uniform2fv(this.addr,e),Mt(t,e)}}function fm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;n.uniform3fv(this.addr,e),Mt(t,e)}}function pm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;n.uniform4fv(this.addr,e),Mt(t,e)}}function mm(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(St(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,i))return;Al.set(i),n.uniformMatrix2fv(this.addr,!1,Al),Mt(t,i)}}function gm(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(St(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,i))return;bl.set(i),n.uniformMatrix3fv(this.addr,!1,bl),Mt(t,i)}}function vm(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(St(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,i))return;Tl.set(i),n.uniformMatrix4fv(this.addr,!1,Tl),Mt(t,i)}}function _m(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function xm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;n.uniform2iv(this.addr,e),Mt(t,e)}}function Sm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;n.uniform3iv(this.addr,e),Mt(t,e)}}function Mm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;n.uniform4iv(this.addr,e),Mt(t,e)}}function ym(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Em(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;n.uniform2uiv(this.addr,e),Mt(t,e)}}function Tm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;n.uniform3uiv(this.addr,e),Mt(t,e)}}function bm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;n.uniform4uiv(this.addr,e),Mt(t,e)}}function Am(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(Ml.compareFunction=_c,r=Ml):r=Fc,t.setTexture2D(e||r,s)}function wm(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||Bc,s)}function Rm(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||zc,s)}function Cm(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||Oc,s)}function Pm(n){switch(n){case 5126:return hm;case 35664:return dm;case 35665:return fm;case 35666:return pm;case 35674:return mm;case 35675:return gm;case 35676:return vm;case 5124:case 35670:return _m;case 35667:case 35671:return xm;case 35668:case 35672:return Sm;case 35669:case 35673:return Mm;case 5125:return ym;case 36294:return Em;case 36295:return Tm;case 36296:return bm;case 35678:case 36198:case 36298:case 36306:case 35682:return Am;case 35679:case 36299:case 36307:return wm;case 35680:case 36300:case 36308:case 36293:return Rm;case 36289:case 36303:case 36311:case 36292:return Cm}}function Dm(n,e){n.uniform1fv(this.addr,e)}function Um(n,e){const t=ji(e,this.size,2);n.uniform2fv(this.addr,t)}function Im(n,e){const t=ji(e,this.size,3);n.uniform3fv(this.addr,t)}function Lm(n,e){const t=ji(e,this.size,4);n.uniform4fv(this.addr,t)}function Nm(n,e){const t=ji(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Fm(n,e){const t=ji(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Om(n,e){const t=ji(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Bm(n,e){n.uniform1iv(this.addr,e)}function zm(n,e){n.uniform2iv(this.addr,e)}function Hm(n,e){n.uniform3iv(this.addr,e)}function km(n,e){n.uniform4iv(this.addr,e)}function Gm(n,e){n.uniform1uiv(this.addr,e)}function Vm(n,e){n.uniform2uiv(this.addr,e)}function Wm(n,e){n.uniform3uiv(this.addr,e)}function Xm(n,e){n.uniform4uiv(this.addr,e)}function qm(n,e,t){const i=this.cache,s=e.length,r=_r(t,s);St(i,r)||(n.uniform1iv(this.addr,r),Mt(i,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||Fc,r[a])}function Ym(n,e,t){const i=this.cache,s=e.length,r=_r(t,s);St(i,r)||(n.uniform1iv(this.addr,r),Mt(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Bc,r[a])}function $m(n,e,t){const i=this.cache,s=e.length,r=_r(t,s);St(i,r)||(n.uniform1iv(this.addr,r),Mt(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||zc,r[a])}function Km(n,e,t){const i=this.cache,s=e.length,r=_r(t,s);St(i,r)||(n.uniform1iv(this.addr,r),Mt(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Oc,r[a])}function Zm(n){switch(n){case 5126:return Dm;case 35664:return Um;case 35665:return Im;case 35666:return Lm;case 35674:return Nm;case 35675:return Fm;case 35676:return Om;case 5124:case 35670:return Bm;case 35667:case 35671:return zm;case 35668:case 35672:return Hm;case 35669:case 35673:return km;case 5125:return Gm;case 36294:return Vm;case 36295:return Wm;case 36296:return Xm;case 35678:case 36198:case 36298:case 36306:case 35682:return qm;case 35679:case 36299:case 36307:return Ym;case 35680:case 36300:case 36308:case 36293:return $m;case 36289:case 36303:case 36311:case 36292:return Km}}class jm{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Pm(t.type)}}class Jm{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Zm(t.type)}}class Qm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const na=/(\w+)(\])?(\[|\.)?/g;function wl(n,e){n.seq.push(e),n.map[e.id]=e}function eg(n,e,t){const i=n.name,s=i.length;for(na.lastIndex=0;;){const r=na.exec(i),a=na.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){wl(t,c===void 0?new jm(o,n,e):new Jm(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new Qm(o),wl(t,h)),t=h}}}class cr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);eg(r,a,this)}}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function Rl(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const tg=37297;let ng=0;function ig(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const Cl=new Oe;function sg(n){qe._getMatrix(Cl,qe.workingColorSpace,n);const e=`mat3( ${Cl.elements.map(t=>t.toFixed(4))} )`;switch(qe.getTransfer(n)){case dr:return[e,"LinearTransferOETF"];case nt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Pl(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+ig(n.getShaderSource(e),o)}else return r}function rg(n,e){const t=sg(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function ag(n,e){let t;switch(e){case Wu:t="Linear";break;case Xu:t="Reinhard";break;case qu:t="Cineon";break;case Yu:t="ACESFilmic";break;case Ku:t="AgX";break;case Zu:t="Neutral";break;case $u:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Qs=new D;function og(){qe.getLuminanceCoefficients(Qs);const n=Qs.x.toFixed(4),e=Qs.y.toFixed(4),t=Qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function gg(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===lc?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Eu?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===bn&&(e="SHADOWMAP_TYPE_VSM"),e}function vg(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Vi:case Wi:e="ENVMAP_TYPE_CUBE";break;case gr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _g(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Wi:e="ENVMAP_MODE_REFRACTION";break}return e}function xg(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case cc:e="ENVMAP_BLENDING_MULTIPLY";break;case Gu:e="ENVMAP_BLENDING_MIX";break;case Vu:e="ENVMAP_BLENDING_ADD";break}return e}function Sg(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Mg(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=gg(t),c=vg(t),u=_g(t),h=xg(t),d=Sg(t),p=lg(t),g=cg(r),_=s.createProgram();let m,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
}`;const ia=n=>n*n*n*(n*(n*6-15)+10);function Gn(n,e,t,i,s){const r=(n%i+i)%i,a=(e%i+i)%i,o=(t%i+i)%i;let l=Math.imul(r+1,668265261)^Math.imul(a+1,374761393)^Math.imul(o+1,2654435769)^s;return l=Math.imul(l^l>>>15,2246822507),l^=l>>>13,l=Math.imul(l,3266489909),l^=l>>>16,(l>>>0)/4294967296}function Sv(n,e,t,i,s){const r=Math.floor(n),a=Math.floor(e),o=Math.floor(t),l=ia(n-r),c=ia(e-a),u=ia(t-o),h=Gn(r,a,o,i,s),d=Gn(r+1,a,o,i,s),p=Gn(r,a+1,o,i,s),g=Gn(r+1,a+1,o,i,s),_=Gn(r,a,o+1,i,s),m=Gn(r+1,a,o+1,i,s),f=Gn(r,a+1,o+1,i,s),b=Gn(r+1,a+1,o+1,i,s),T=h+(d-h)*l,S=p+(g-p)*l,A=_+(m-_)*l,R=f+(b-f)*l,C=T+(S-T)*c,N=A+(R-A)*c;return C+(N-C)*u}function Mv(n=64){const e=new Uint8Array(n*n*n),t=8,i=t/n;let s=0;for(let a=0;a<n;a++)for(let o=0;o<n;o++)for(let l=0;l<n;l++){const c=Sv(l*i,o*i,a*i,t,13);e[s++]=Math.max(0,Math.min(255,Math.round(c*255)))}const r=new Mc(e,n,n,n);return r.format=ho,r.type=At,r.minFilter=st,r.magFilter=st,r.wrapS=Hi,r.wrapT=Hi,r.wrapR=Hi,r.unpackAlignment=1,r.needsUpdate=!0,r}const yv={galaxy:0,timeline:1,sets:2,colorwheel:3,sphere:4,price:5};function Ev(){const n=new Dc(new Float32Array(4),1,1,Bt,sn);return n.needsUpdate=!0,n.minFilter=st,n.magFilter=st,n.wrapS=n.wrapT=An,n}function Tv(n,e=128){const t=n.length/4|0;let i=1;for(let o=0;o<t;o++){const l=n[o*4],c=n[o*4+2],u=n[o*4+3];i=Math.max(i,Math.hypot(l,c)+u*2.4)}const s=new Float32Array(e*e*4),r=1/e;for(let o=0;o<e;o++){const l=(o*r*2-1)*i;for(let c=0;c<e;c++){const u=(c*r*2-1)*i;let h=0;for(let p=0;p<t;p++){const g=n[p*4],_=n[p*4+2],m=Math.max(1.8,n[p*4+3]),f=(u-g)*(u-g)+(l-_)*(l-_),b=m*m;f<b*4&&(h=Math.max(h,Math.exp(-f/(b*.55))))}const d=(o*e+c)*4;s[d]=h>.22?Math.min(1,h):0}}const a=new Dc(s,e,e,Bt,sn);return a.needsUpdate=!0,a.minFilter=st,a.magFilter=st,a.wrapS=a.wrapT=An,a.generateMipmaps=!1,{texture:a,extent:i}}class bv{compositeMesh;marchScene=new xs;marchCamera=new To(-1,1,1,-1,0,1);marchMaterial;compositeMaterial;target;scale;width=1;height=1;targetDensity=1;dummyTex;skipRender=!1;lastPose="";baseSteps=52;dirty=!0;clusterCache=new Map;constructor(e=.5){this.scale=e,this.target=new gt(1,1,{format:Bt,type:$n,minFilter:st,magFilter:st,depthBuffer:!1,stencilBuffer:!1}),this.marchMaterial=new ft({vertexShader:_v,fragmentShader:xv,glslVersion:fr,uniforms:{uInvProjection:{value:new lt},uCameraWorld:{value:new lt},uCamPos:{value:new D},uTime:{value:0},uIntensity:{value:1},uSteps:{value:52},uNoiseScale:{value:.0042},uDensity:{value:1},uWarp:{value:.85},uStarfield:{value:1},uResolution:{value:new Te(1,1)},uWorldScale:{value:1},uLayout:{value:0},uBound:{value:360},uYearMin:{value:1993},uYearCount:{value:33},uClusterMap:{value:Ev()},uClusterExtent:{value:1},uNoise:{value:Mv(64)}},depthTest:!1,depthWrite:!1}),this.dummyTex=this.marchMaterial.uniforms.uClusterMap.value,this.marchScene.add(new Zt(new $i(2,2),this.marchMaterial)),this.compositeMaterial=new ft({uniforms:{uMap:{value:this.target.texture}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = vec4(position.xy, 1.0, 1.0);
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(n)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(n,e=Ss){this.fullscreenMaterial.depthBuffer=n,this.fullscreenMaterial.depthPacking=e;for(const t of this.effects)t.setDepthTexture(n,e)}render(n,e,t,i,s){for(const r of this.effects)r.update(n,e,i);if(!this.skipRendering||this.renderToScreen){const r=this.fullscreenMaterial;r.inputBuffer=e.texture,r.time+=i*this.timeScale,n.setRenderTarget(this.renderToScreen?null:t),n.render(this.scene,this.camera)}}setSize(n,e){this.fullscreenMaterial.setSize(n,e);for(const t of this.effects)t.setSize(n,e)}initialize(n,e,t){this.renderer=n;for(const i of this.effects)i.initialize(n,e,t);this.updateMaterial(),t!==void 0&&t!==At&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const n of this.effects)n.removeEventListener("change",this.listener),n.dispose()}handleEvent(n){switch(n.type){case"change":this.recompile();break}}};class _0 extends Jt{accumulation;blendMaterial;copyMaterial;constructor(e=.45){super("TrailPass"),this.needsSwap=!0,this.accumulation=new gt(1,1,{type:$n,minFilter:st,magFilter:st,depthBuffer:!1,stencilBuffer:!1}),this.blendMaterial=new ft({uniforms:{inputBuffer:{value:null},tPrevious:{value:this.accumulation.texture},uAmount:{value:e}},vertexShader:ic,fragmentShader:`
      ...
      `,depthTest:!1,depthWrite:!1}),this.copyMaterial=new ft({uniforms:{inputBuffer:{value:null}},vertexShader:ic,fragmentShader:`
        uniform sampler2D inputBuffer;
        varying vec2 vUv;
...
`;function x0(n,e,t){const i=new n_(n,{frameBufferType:$n});i.addPass(new i0(e,t));const s=new _0(.45);s.enabled=!1,i.addPass(s);const r=new Q_({blendFunction:ke.ADD,intensity:1.05,luminanceThreshold:.42,luminanceSmoothing:.22,mipmapBlur:!0,radius:.74,kernelSize:Mr.LARGE}),a=new n0({offset:new Te(32e-5,32e-5),radialModulation:!0,modulationOffset:.42}),o=new d0({offset:.26,darkness:.66}),l=new r0({blendFunction:ke.OVERLAY,premultiply:!0});l.blendMode.opacity.value=.028;const c=new u0({mode:kt.ACES_FILMIC,resolution:256,whitePoint:6.5,middleGrey:.4});return i.addPass(new v0(t,r,a,o,l,c)),{composer:i,setBloom:u=>{r.intensity=u*1.05},setExposure:u=>{n.toneMappingExposure=u},setTrails:u=>{s.enabled=u},setSize:(u,h)=>i.setSize(u,h),dispose:()=>i.dispose()}}const Zc="aetherfield";let os=null;function hi(){if(os!==null)return os;try{os=window.top!==window.self}catch{os=!0}return os}function Ro(n){if(hi())try{window.parent.postMessage({source:Zc,...n},"*")}catch{}}function S0(){if(!hi())return()=>{};const n=e=>{if(e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey)return;const t=e.target;if(!(t instanceof Element))return;const i=t.closest("a[href]");if(!(i instanceof HTMLAnchorElement))return;let s;try{s=new URL(i.href)}catch{return}s.protocol!=="http:"&&s.protocol!=="https:"||s.origin!==window.location.origin&&(e.preventDefault(),Ro({type:"open-external",url:s.href}))};return document.addEventListener("click",n,!0),()=>document.removeEventListener("click",n,!0)}function M0(n){if(!hi())return()=>{};const e=t=>{if(t.source!==window.parent)return;const i=t.data;if(!i||typeof i!="object"||i.source!==Zc)return;const s=i.type;(s==="highlight"||s==="show-set"||s==="clear-highlight")&&n(i)};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)}const y0=["galaxy","timeline","sets","colorwheel","sphere","price"],sc=n=>n!==null&&y0.includes(n),E0=n=>n==="title"||n==="play";let jc=!1;function T0(n,e){for(const t of n.replace(/^\?/,"").split("&")){const i=t.indexOf("=");if(!(i<0)&&t.slice(0,i)===e)return t.slice(i+1)}return null}function b0(n){try{return decodeURIComponent(n.replace(/\+/g," ")).trim()}catch{return null}}function A0(n,e){const t=new Set,i=s=>{if(!s)return!1;const r=n.indexOfUuid(s);if(r>=0)return t.add(n.col.oracleIdx[r]),!0;const a=n.oraclesNamed(s);for(const o of a)t.add(o);return a.length>0};for(const s of e.split(",")){const r=b0(s);if(r!==null&&!i(r)&&r.includes(","))for(const a of r.split(","))i(a.trim())}return t}function w0(n,e){const t=[],i=new Set;for(const s of e){const r=n.nameOfOracle(s);!r||i.has(r)||(i.add(r),t.push(encodeURIComponent(r)))}return t.join(",")}function R0(n){const e=new URLSearchParams(window.location.search),t=e.get("layout");sc(t)&&ae.set("layout",t);const i=e.get("card");if(i){const p=n.indexOfUuid(i);p>=0?ae.set("selected",p):console.warn(`[mcu] no card matches ?card=${i}`)}const s=E0(e.get("shell"));s&&ae.set("shell",e.get("shell")),jc=s&&e.get("shell")==="play";const r=e.get("set");if(r){const p=n.indexOfSetCode(r);p>=0?(ae.patchFilter({sets:new Set([p])}),sc(t)||ae.set("layout","sets")):console.warn(`[mcu] no set matches ?set=${r}`)}const a=T0(window.location.search,"cards");if(a){const p=A0(n,a);p.size>0?(ae.patchFilter({oracles:new Set(p)}),ae.set("highlightOracles",new Set(p))):console.warn("[mcu] no cards matched ?cards=")}let o=0;const l=()=>{o||(o=window.setTimeout(()=>{o=0;const p=new URLSearchParams;s&&p.set("shell",ae.state.shell),ae.state.selected>=0&&p.set("card",n.uuid(ae.state.selected));let g="";if(ae.state.filter.sets.size===1){const T=[...ae.state.filter.sets][0];g=n.meta.sets[T]?.code??"",g&&p.set("set",g)}const _=ae.state.layout;(_!=="galaxy"||g)&&p.set("layout",_);const m=w0(n,ae.state.filter.oracles),f=m?C0(p.toString(),"cards",m):p.toString(),b=f?`${window.location.pathname}?${f}`:window.location.pathname;window.history.replaceState(null,"",b)},250))},c=ae.on("selected",l),u=ae.on("layout",l),h=ae.on("filter",l),d=ae.on("shell",l);return()=>{c(),u(),h(),d(),o&&clearTimeout(o)}}function C0(n,e,t){return n?`${n}&${e}=${t}`:`${e}=${t}`}const ua=55,P0=5,Jc=[{nebulaScale:.24,steps:24,renderScale:.78},{nebulaScale:.28,steps:28,renderScale:.88},{nebulaScale:.34,steps:32,renderScale:.95},{nebulaScale:.4,steps:38,renderScale:1},{nebulaScale:.46,steps:46,renderScale:1},{nebulaScale:.52,steps:54,renderScale:1}],ha=Jc.length-1;class D0{rig;starfield;renderer;scene=new xs;camera;nebula;picker;billboards;labels;coreGlow=new Bv;printingTrail;eraMarkers;post;universe;canvas;options;mask;tmpVec=new D;clock=new od;raf=0;running=!1;pointerDown={x:0,y:0,t:0};pointerInside=!1;lastPointer={x:0,y:0};lastPickPose=new Float64Array(7);poseScratch=new Float64Array(7);frames=0;fpsAccum=0;filterQueued=!1;tier=ha;pinnedTier=!1;renderScale=1;tierCooldown=0;disposers=[];galaxyBound=1;worldScale=1;targetWorldScale=1;lastCameraPick=0;constructor(e,t,i={}){this.canvas=e,this.universe=t,this.options=i,this.mask=new Uint8Array(t.count).fill(1),this.renderer=new Kg({canvas:e,antialias:!1,alpha:!1,powerPreference:"high-performance",stencil:!1}),this.renderer.setClearColor(0,1),this.renderer.toneMapping=wn,this.renderer.autoClear=!0,this.camera=new $t(ua,1,.1,8e3),this.rig=new Jg(this.camera,e),this.starfield=new vv(t),this.nebula=new bv(.5),this.picker=new Rv(this.starfield),this.billboards=new Uv(t,this.starfield,this.mask),this.labels=new Fv(t,this.starfield,this.mask),this.printingTrail=new Xv(t,this.starfield),this.eraMarkers=new $v(this.starfield.ctx),this.scene.add(this.nebula.compositeMesh),this.scene.add(this.starfield.points),this.scene.add(this.billboards.group),this.scene.add(this.labels.group),this.scene.add(this.coreGlow.group),this.scene.add(this.eraMarkers.group),this.scene.add(this.printingTrail.line),this.post=x0(this.renderer,this.scene,this.camera),this.bindEvents(),this.bindStore(),this.galaxyBound=Math.max(1,this.starfield.boundingRadius),this.nebula.setLayout("galaxy",{bound:this.galaxyBound,yearMin:this.starfield.ctx.yearMin,yearMax:this.starfield.ctx.yearMax}),this.tier=hi()?1:2,this.resize(),this.applyQuality();const s=this.framedDistance();this.rig.setPhi(this.starfield.framePhi()),this.rig.setRadius(s*3.4),this.rig.flyTo(new D(0,0,0),s,.62),this.applyVisual(ae.state.visual),this.applyFilter(),this.applyHighlight()}get qualityTier(){return this.tier}setQualityTier(e){this.pinnedTier=e>=0,this.pinnedTier&&(this.tier=Math.max(0,Math.min(ha,Math.round(e))),this.applyQuality())}start(){if(this.running)return;this.running=!0,this.clock.start();const e=()=>{this.raf=requestAnimationFrame(e),this.frame()};this.raf=requestAnimationFrame(e)}stop(){this.running=!1,cancelAnimationFrame(this.raf)}bindEvents(){const e=(t,i,s,r)=>{t.addEventListener(i,s,r),this.disposers.push(()=>t.removeEventListener(i,s))};e(this.canvas,"pointermove",t=>{this.pointerInside=!0;const i=this.canvas.getBoundingClientRect();this.lastPointer={x:t.clientX-i.left,y:t.clientY-i.top},this.picker.request(this.lastPointer.x,this.lastPointer.y)}),e(this.canvas,"pointerleave",()=>{this.pointerInside=!1,ae.set("hovered",-1),this.options.onHoverAnchor?.(null)}),e(this.canvas,"pointerdown",t=>{this.pointerDown={x:t.clientX,y:t.clientY,t:performance.now()}}),e(this.canvas,"pointerup",t=>{if(Math.hypot(t.clientX-this.pointerDown.x,t.clientY-this.pointerDown.y)>P0||performance.now()-this.pointerDown.t>700)return;const s=ae.state.hovered;ae.set("selected",s)}),e(window,"keydown",t=>{if(ae.state.shell==="title")return;if(t.key==="Escape"){if(this.rig.isCinematic){this.rig.skipCinematic(),ae.set("cinematic",!1);return}ae.set("selected",-1);return}const i=document.activeElement;if(i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.isContentEditable)||t.metaKey||t.ctrlKey||t.altKey)return;const s=t.key.toLowerCase();s==="r"?(t.preventDefault(),this.selectRandomCard()):(s==="f"||s==="home")&&(t.preventDefault(),this.resetView())}),e(window,"resize",()=>this.resize()),e(this.canvas,"webglcontextlost",t=>{t.preventDefault(),this.stop(),ae.set("loadLabel","Graphics context lost — reload to continue")})}bindStore(){this.disposers.push(ae.on("layout",e=>this.applyLayout(e)),ae.on("filter",()=>{this.filterQueued||(this.filterQueued=!0,requestAnimationFrame(()=>{this.filterQueued=!1,this.applyFilter()}))}),ae.on("visual",e=>this.applyVisual(e)),ae.on("selected",e=>this.applySelection(e)),ae.on("hovered",e=>{this.starfield.setHoverOracle(e>=0?this.universe.col.oracleIdx[e]:-1)}),ae.on("formatFocus",e=>{this.starfield.setFormatBit(e?ac[e]:0)}),ae.on("highlightOracles",()=>this.applyHighlight()),ae.on("cameraCue",e=>this.consumeCue(e)),ae.on("shell",e=>{this.rig.setInputEnabled(e==="play"),this.labels.setEnabled(ae.state.visual.showLabels&&e==="play"),this.eraMarkers.setEnabled(e==="play");const t=navigator.webdriver===!0;e==="play"&&!jc&&!hi()&&!t&&(this.rig.playCinematic(this.framedDistance(),this.starfield.framePhi(),45),ae.set("cinematic",!0)),e==="title"&&(this.rig.skipCinematic(),ae.set("cinematic",!1))}),ae.on("insets",()=>{this.resize(),this.rig.distance>260&&this.rig.frame(this.framedDistance())})),this.rig.setInputEnabled(ae.state.shell==="play")}resetView(){ae.set("selected",-1),this.rig.frame(this.framedDistance()),this.rig.setPhi(this.starfield.framePhi())}selectRandomCard(){const e=this.universe.col.popularity,t=this.universe.count;let i=-1,s=-1;for(let r=0;r<64;r++){const a=Math.random()*t|0;if(this.mask[a]===0)continue;const o=e[a]/65535*Math.random();o>s&&(s=o,i=a)}i>=0&&ae.set("selected",i)}applyLayout(e){this.starfield.setLayout(e),this.targetWorldScale=this.starfield.boundingRadius/this.galaxyBound,this.eraMarkers.setLayout(e),this.nebula.setLayout(e,{bound:this.starfield.boundingRadius,yearMin:this.starfield.ctx.yearMin,yearMax:this.starfield.ctx.yearMax,clusters:e==="sets"?Hc(this.starfield.ctx):void 0}),this.rig.distance>260&&(this.rig.frame(this.framedDistance()),this.rig.setPhi(this.starfield.framePhi())),this.applyNebulaDensity(),this.printingTrail.setLayoutSupported(e==="galaxy"||e==="price"||e==="timeline")}applyNebulaDensity(){if(!ae.state.visual.showNebula){this.nebula.setDensity(0),this.coreGlow.setStrength(0);return}const e=ae.state.layout,t=e==="galaxy"?1:e==="sets"?.42:e==="timeline"?.7:.75,i=e==="galaxy"?1:.45;let r=.12+.88*(this.universe.count>0?ae.state.matchCount/this.universe.count:1);ae.state.highlightOracles.size>0&&ae.state.filter.oracles.size===0&&(r*=.4),this.nebula.setDensity(t*r),this.coreGlow.setStrength(i*r)}applyFilter(){const e=this.universe.applyFilter(ae.state.filter,this.mask);this.starfield.setVisibility(this.mask),ae.set("matchCount",e),this.applyNebulaDensity()}applyVisual(e){const t=this.starfield.material.uniforms;t.uStarSize.value=e.starSize,t.uDim.value=e.dimFiltered,t.uExposure.value=e.exposure,this.post.setBloom(e.bloom),this.post.setTrails(e.motionBlur),this.nebula.setIntensity(e.nebula),this.applyNebulaDensity(),this.rig.autoRotate=e.autoRotate,this.labels.setEnabled(e.showLabels&&ae.state.shell==="play")}applyHighlight(){const e=ae.state.highlightOracles;if(e.size===0)this.starfield.setHighlight(null);else{const t=new Uint8Array(this.universe.count),i=this.universe.col.oracleIdx;for(let s=0;s<this.universe.count;s++)e.has(i[s])&&(t[s]=255);this.starfield.setHighlight(t)}this.applyNebulaDensity()}consumeCue(e){if(e){if(e.kind==="skip-cinematic")this.rig.skipCinematic(),ae.set("cinematic",!1);else if(e.kind==="cinematic")this.rig.playCinematic(this.framedDistance(),this.starfield.framePhi(),45),ae.set("cinematic",!0);else if(e.kind==="bookmark")this.rig.restore(e);else if(e.kind==="arm"){const t=ro[Tt[e.color]]??0;this.rig.setAngles(Math.PI/2-t,this.starfield.framePhi()),this.rig.frame(this.framedDistance())}ae.set("cameraCue",null)}}applySelection(e){if(this.starfield.material.uniforms.uSelected.value=e,this.printingTrail.setCard(e),e<0){this.starfield.setSelectedOracle(-1);return}this.starfield.setSelectedOracle(this.universe.col.oracleIdx[e]),this.starfield.positionOf(e,this.tmpVec),this.rig.flyTo(this.tmpVec,Math.min(this.rig.distance,120),1.45)}viewport(){const e=Math.max(1,this.canvas.clientWidth||window.innerWidth),t=Math.max(1,this.canvas.clientHeight||window.innerHeight),{left:i,right:s}=ae.state.insets,r=Math.min(i,e*.5),a=Math.max(1,e-r-Math.min(s,e*.25));return{cssW:e,cssH:t,freeW:a,insetLeft:r}}framedDistance(){const{cssH:e,freeW:t}=this.viewport();return this.starfield.frameDistance(t/e)}resize(){const{cssW:e,cssH:t,insetLeft:i}=this.viewport(),s=hi()?1.25:1.5,r=Math.min(window.devicePixelRatio||1,s)*this.renderScale;this.renderer.setPixelRatio(r),this.renderer.setSize(e,t,!1),this.camera.aspect=e/t,i>.5?this.camera.setViewOffset(e,t,-i/2,0,e,t):this.camera.clearViewOffset(),this.camera.updateProjectionMatrix(),this.post.setSize(e,t),this.nebula.setSize(e*r,t*r),this.printingTrail.setSize(e,t),this.starfield.setViewport(t*r,ua),this.picker.setViewport(e,t,ua)}frame(){const e=Math.min(this.clock.getDelta(),.1),t=this.clock.elapsedTime;this.rig.update(e),this.starfield.update(e,t),this.worldScale+=(this.targetWorldScale-this.worldScale)*(1-Math.exp(-e*2.2)),this.nebula.setWorldScale(this.worldScale),this.coreGlow.setWorldScale(Math.min(1.25,this.worldScale)),this.nebula.update(e),this.billboards.update(e,this.camera,this.rig.distance,ae.state.hovered,ae.state.selected),this.labels.update(e,this.camera,this.rig.distance),this.coreGlow.update(e),this.eraMarkers.update(e,this.camera),this.printingTrail.update(e);const i=this.rig.idleSeconds<.35||this.starfield.isMorphing||this.rig.isCinematic;if(this.nebula.prepareFrame(this.camera,this.rig.distance,this.starfield.boundingRadius,i),this.nebula.render(this.renderer,this.camera,t),ae.state.cinematic&&!this.rig.isCinematic&&ae.set("cinematic",!1),this.post.composer.render(e),this.pointerInside){const s=performance.now();s-this.lastCameraPick>100&&this.readPose(this.poseScratch)&&(this.lastPickPose.set(this.poseScratch),this.lastCameraPick=s,this.picker.request(this.lastPointer.x,this.lastPointer.y))}if(this.pointerInside){const{cssW:s,cssH:r}=this.viewport(),a=this.billboards.hitTest(this.camera,this.lastPointer.x,this.lastPointer.y,s,r);a>=0?a!==ae.state.hovered&&(ae.set("hovered",a),this.starfield.material.uniforms.uHovered.value=a):this.picker.poll(this.renderer,this.camera,o=>{const c=o>=0&&o<this.universe.count?o:-1;c!==ae.state.hovered&&(ae.set("hovered",c),this.starfield.material.uniforms.uHovered.value=c)})}this.updateHoverAnchor(),this.updateStats(e)}updateHoverAnchor(){const e=this.options.onHoverAnchor;if(!e)return;const t=ae.state.hovered;if(t<0){e(null);return}if(this.starfield.positionOf(t,this.tmpVec).project(this.camera),this.tmpVec.z>1){e(null);return}const i=this.canvas.getBoundingClientRect();e({x:i.left+(this.tmpVec.x+1)/2*i.width,y:i.top+(1-this.tmpVec.y)/2*i.height})}readPose(e){const t=this.rig.target,i=this.camera.position;e[0]=Math.round(this.rig.distance*10),e[1]=Math.round(t.x*10),e[2]=Math.round(t.y*10),e[3]=Math.round(t.z*10),e[4]=Math.round(i.x*10),e[5]=Math.round(i.y*10),e[6]=Math.round(i.z*10);for(let s=0;s<7;s++)if(e[s]!==this.lastPickPose[s])return!0;return!1}updateStats(e){if(this.frames++,this.fpsAccum+=e,this.fpsAccum<.4)return;const t=this.fpsAccum,i=Math.round(this.frames/t);ae.set("stats",{fps:i,visible:ae.state.matchCount,total:this.universe.count,drawCalls:this.renderer.info.render.calls,ms:+(t/this.frames*1e3).toFixed(2)}),this.frames=0,this.fpsAccum=0,this.adaptQuality(i,t)}adaptQuality(e,t){if(!this.pinnedTier&&(this.tierCooldown=Math.max(0,this.tierCooldown-t),!(this.tierCooldown>0)&&!this.starfield.isMorphing)){if(e<42&&this.tier>0){const i=42-e,s=i>16?3:i>8?2:1;this.tier=Math.max(0,this.tier-s),this.tierCooldown=1.6}else if(e>58&&this.tier<ha)this.tier++,this.tierCooldown=9;else return;this.applyQuality()}}applyQuality(){const e=Jc[this.tier];this.nebula.setQuality(e.nebulaScale,e.steps),e.renderScale!==this.renderScale&&(this.renderScale=e.renderScale,this.resize())}dispose(){this.stop();for(const e of this.disposers)e();this.disposers.length=0,this.rig.dispose(),this.starfield.dispose(),this.nebula.dispose(),this.picker.dispose(),this.billboards.dispose(),this.labels.dispose(),this.coreGlow.dispose(),this.eraMarkers.dispose(),this.printingTrail.dispose(),this.post.dispose(),this.renderer.dispose()}}const Qc="aetherfield.settings.v2",U0=400,I0={bloom:[0,3],exposure:[0,3],starSize:[0,3],nebula:[0,2],dimFiltered:[0,1]},L0=["showNebula","showLabels","motionBlur","autoRotate"];function N0(n,e,t){return typeof n!="number"||!Number.isFinite(n)?null:Math.min(t,Math.max(e,n))}function F0(){let n=null;try{n=localStorage.getItem(Qc)}catch{return}if(!n)return;let e;try{e=JSON.parse(n)}catch{return}if(typeof e!="object"||e===null)return;const t=e,i={};for(const[s,[r,a]]of Object.entries(I0)){const o=N0(t[s],r,a);o!==null&&(i[s]=o)}for(const s of L0)typeof t[s]=="boolean"&&(i[s]=t[s]);Object.keys(i).length>0&&ae.patchVisual(i)}function O0(){let n=0;const e=()=>{n=0;try{localStorage.setItem(Qc,JSON.stringify(ae.state.visual))}catch{}},t=ae.on("visual",()=>{n||(n=window.setTimeout(e,U0))}),i=()=>{n&&(clearTimeout(n),e())};return window.addEventListener("pagehide",i),()=>{t(),i(),window.removeEventListener("pagehide",i)}}const di={root:document.getElementById("boot"),fill:document.getElementById("boot-fill"),label:document.getElementById("boot-label")};function da(n,e){di.fill.style.width=`${Math.round(n*100)}%`,di.label.textContent=e}function eu(n){di.label.classList.add("error"),di.label.textContent=n,di.fill.style.background="#ff8f7a",Ro({type:"error",message:n})}async function B0(){const n=document.getElementById("stage"),e=document.getElementById("ui-root");if(S0(),!n.getContext("webgl2")){eu("This needs WebGL2, which this browser or GPU does not provide.");return}const t=await Su((l,c)=>{ae.set("loadProgress",l),ae.set("loadLabel",c),da(l,c)});F0();const i={cameraSnapshot:()=>({theta:0,phi:1.07,radius:900,target:[0,0,0]})};let s=null;try{s=(await cu(()=>import("./index-CWss8mQ-.js"),__vite__mapDeps([0,1]),import.meta.url)).mountUI(e,t,i)}catch(l){console.warn("[mcu] UI layer unavailable, running renderer only:",l)}R0(t),O0(),da(.9,"Igniting stars");const r=new D0(n,t,{onHoverAnchor:l=>s?.setHoverAnchor(l)});i.cameraSnapshot=()=>r.rig.snapshot(),r.start(),M0(l=>{if(l.type==="clear-highlight"){ae.set("highlightOracles",new Set),ae.patchFilter({oracles:rc().oracles});return}if(l.type==="show-set"){const u=t.indexOfSetCode(l.code);if(u<0)return;ae.patchFilter({sets:new Set([u])}),ae.set("layout","sets");return}const c=new Set;for(const u of l.uuids??[]){const h=t.indexOfUuid(u);h>=0&&c.add(t.col.oracleIdx[h])}for(const u of l.names??[])for(const h of t.oraclesNamed(u))c.add(h);ae.set("highlightOracles",c)}),await new Promise(l=>requestAnimationFrame(()=>requestAnimationFrame(()=>l()))),da(1,`${t.count.toLocaleString()} cards charted`),ae.set("loadProgress",1),ae.set("ready",!0),Ro({type:"ready",cards:t.count}),di.root.classList.add("done"),setTimeout(()=>di.root.remove(),900),Object.assign(window,{__mcu:{app:r,universe:t,store:ae,ui:s}});const a=location.pathname==="/"||location.pathname==="/index.html";if(!hi()&&location.protocol.startsWith("http")&&a&&"serviceWorker"in navigator){const l=new URL("sw.js",document.baseURI).href;navigator.serviceWorker.register(l).catch(()=>{})}}B0().catch(n=>{console.error("[mcu] boot failed",n),eu(n instanceof Error?n.message:String(n))});export{z0 as C,ac as F,uu as a,ro as b,Tt as c,rc as d,hi as i,us as r,ae as s};
