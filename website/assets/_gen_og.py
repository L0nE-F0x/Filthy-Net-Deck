...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.4.1  {mid}  POLISH PASS"
    ...
    lines = [
        ...
        "Share menus · Soundscape · Ugin & Garruk.",
        "Fresh Events · hardened overlay.",
    ...
    draw.text((70, H - 40), "v1.4.1  ·  Windows + macOS", font=small_font, fill=MUTED)
