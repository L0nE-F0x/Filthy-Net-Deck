...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.2.0  {mid}  COPY THE OPPONENT'S DECK"
    ...
    lines = [
        "Matchup Lab reads the cards they revealed.",
        "Guesses their deck; copy the closest ranked list.",
        "Send it to Brew Lab to grade and improve on.",
    ...
    draw.text((70, H - 40), "v2.2.0  ·  Windows + macOS", font=small_font, fill=MUTED)
