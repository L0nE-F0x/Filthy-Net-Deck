...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.22  {mid}  FUTURE STANDARD + CTRL+K CARD WATCH"
    ...
    lines = [
        ...
        f"Future Standard roadmap sets {mid} official sources.",
        f"Ctrl+K: every meta deck playing any card.",
    ...
    draw.text((70, H - 40), "v0.22.0  ·  Windows + macOS", font=small_font, fill=MUTED)
