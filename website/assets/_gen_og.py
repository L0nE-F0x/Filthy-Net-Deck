...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.1.0  {mid}  SPOILERS BEFORE SCRYFALL"
    ...
    lines = [
        "Set Radar scouts MythicSpoiler ahead of Scryfall.",
        "Unconfirmed leaks, clearly labeled, self-clearing.",
        "Radar refresh now runs every 4 hours.",
    ...
    draw.text((70, H - 40), "v2.1.0  ·  Windows + macOS", font=small_font, fill=MUTED)
