...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.7.3  {mid}  FULLSCREEN FIX"
    ...
    lines = [
        "Exit fullscreen & Close to tray work again",
        "Windows fullscreen hide fixed · F11 stays in sync",
    ...
    draw.text((70, H - 40), "v2.7.3  ·  Windows + macOS", font=small_font, fill=MUTED)
