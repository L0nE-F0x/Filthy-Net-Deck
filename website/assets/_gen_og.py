...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.13  {mid}  SET RADAR"
    ...
    lines = [
        ...
        f"Set Radar {mid} Arena drop dates {mid} spoilers.",
    ...
    draw.text((70, H - 40), "v0.13.0  ·  Windows + macOS", font=small_font, fill=MUTED)
