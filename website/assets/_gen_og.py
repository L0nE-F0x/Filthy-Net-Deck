...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.8.2  {mid}  HONEST READS"
    ...
    lines = [
        "Opponent colours stay honest — lands can't invent a deck",
        "Friend codes and a seasonal race on Climb",
    ...
    draw.text((70, H - 40), "v2.8.2  ·  Windows + macOS", font=small_font, fill=MUTED)
