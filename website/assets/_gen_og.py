...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.25  {mid}  FORMAT HUB + NEW NAV"
    ...
    lines = [
        ...
        f"Format Hub: legality, rotation, bans.",
        f"Nav: Decks · Stats · Climb · Matchups…",
    ...
    draw.text((70, H - 40), "v0.25.0  ·  Windows + macOS", font=small_font, fill=MUTED)
