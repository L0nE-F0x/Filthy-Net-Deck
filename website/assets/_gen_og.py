...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.4.4  {mid}  TOOLTIPS + EVENTS"
    ...
    lines = [
        ...
        "In-game overlay · share cards · Soundscape.",
        "Fresh Events · last-played stats · hover help.",
    ...
    draw.text((70, H - 40), "v1.4.4  ·  Windows + macOS", font=small_font, fill=MUTED)
