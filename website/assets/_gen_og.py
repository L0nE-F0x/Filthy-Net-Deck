...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.7.6  {mid}  COMMUNITY MATCHUPS"
    ...
    lines = [
        "Your win rate vs every archetype, automatic",
        "See where you beat the field, and where you don't",
    ...
    draw.text((70, H - 40), "v2.7.6  ·  Windows + macOS", font=small_font, fill=MUTED)
