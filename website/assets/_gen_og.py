...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.1  {mid}  HOW MANY CARDS OFF"
    ...
    lines = [
        "See how far your 75 is from today's ranked list",
        "Close-to-tray keeps fullscreen when you come back",
    ...
    draw.text((70, H - 40), "v3.1.1  ·  Windows + macOS", font=small_font, fill=MUTED)
