...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.18  {mid}  CONTENT ENGINE"
    ...
    lines = [
        ...
        f"Archetype diffs {mid} meta timeline {mid} week recaps.",
        f"Set Radar {mid} matchup intel {mid} match-end toasts.",
    ...
    draw.text((70, H - 40), "v0.18.0  ·  Windows + macOS", font=small_font, fill=MUTED)
