...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.3.0  {mid}  ALERTS THAT CLEAR FULLSCREEN"
    ...
    lines = [
        "Windows mutes its banners while a game runs.",
        "Match-end lands in a top-most card instead.",
        "Click-through, so Arena never loses the click.",
    ...
    draw.text((70, H - 40), "v2.3.0  ·  Windows + macOS", font=small_font, fill=MUTED)
