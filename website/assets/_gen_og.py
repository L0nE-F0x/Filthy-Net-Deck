...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.24  {mid}  SEARCH + FULL STANDARD RADAR"
    ...
    lines = [
        ...
        f"Search top bar {mid} denser Settings.",
        f"Recently live: full Standard pool.",
    ...
    draw.text((70, H - 40), "v0.24.0  ·  Windows + macOS", font=small_font, fill=MUTED)
