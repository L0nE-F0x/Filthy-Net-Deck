...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.26  {mid}  CLIMB BY DECK"
    ...
    lines = [
        ...
        f"Climb path shows which deck climbed.",
        f"Click any stretch → full deck stats.",
    ...
    draw.text((70, H - 40), "v0.26.0  ·  Windows + macOS", font=small_font, fill=MUTED)
