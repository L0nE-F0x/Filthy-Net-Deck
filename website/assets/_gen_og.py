...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.5.1  {mid}  .COM DOMAIN"
    ...
    lines = [
        "Official site: filthy-net-deck.com",
        "Daily Standard & Pioneer meta.",
        "Brew Lab · overlay · share cards.",
    ...
    draw.text((70, H - 40), "v1.5.1  ·  Windows + macOS", font=small_font, fill=MUTED)
