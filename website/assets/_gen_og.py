...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.9.7  {mid}  MOVABLE MATCH ALERT"
    ...
    lines = [
        "Drag the match alert anywhere",
        "Record in 1080p, nothing cropped",
        "Reality Fracture Early Access, tracked",
    ]
    ...
    draw.text((70, H - 40), "v3.9.7  ·  Win + macOS + Linux", font=small_font, fill=MUTED)
