...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.8.0  {mid}  DECK BACKUP"
    ...
    lines = [
        ...
        "Decklists backed up — they follow you to any PC",
    ...
    draw.text((70, H - 40), "v2.8.0  ·  Windows + macOS", font=small_font, fill=MUTED)
