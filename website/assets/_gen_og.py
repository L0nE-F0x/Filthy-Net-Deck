...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.13.1  {mid}  FULL GALLERIES"
    ...
    lines = [
        ...
        f"Full card galleries {mid} Arena drop dates.",
    ...
    draw.text((70, H - 40), "v0.13.1  ·  Windows + macOS", font=small_font, fill=MUTED)
