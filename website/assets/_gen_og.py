...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.5  {mid}  SUGGEST / REPORT"
    ...
    lines = [
        "Suggest / Report from the app or the site",
        "Feature ideas and bugs email the maintainer",
    ...
    draw.text((70, H - 40), "v3.1.5  ·  Windows + macOS", font=small_font, fill=MUTED)
