...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.3.5  {mid}  OVERLAY, REFINED"
    ...
    lines = [
        ...
        "Overlay: grouped list, art crops, mana pips.",
        "Draw odds & land count · true slim bar.",
    ...
    draw.text((70, H - 40), "v1.3.5  ·  Windows + macOS", font=small_font, fill=MUTED)
