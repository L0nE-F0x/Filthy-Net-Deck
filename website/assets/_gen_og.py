...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.3  {mid}  RANKED LIST TUCKED AWAY"
    ...
    lines = [
        "Vs today's ranked list starts collapsed under history",
        "Click a match to see the cards they revealed",
    ...
    draw.text((70, H - 40), "v3.1.3  ·  Windows + macOS", font=small_font, fill=MUTED)
