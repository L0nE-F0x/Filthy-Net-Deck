...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.0.3  {mid}  EVERY CARD NAMED"
    ...
    lines = [
        "Brand-new set cards named on every screen",
        "Right mana curve and colour pips from day one",
    ...
    draw.text((70, H - 40), "v3.0.3  ·  Windows + macOS", font=small_font, fill=MUTED)
