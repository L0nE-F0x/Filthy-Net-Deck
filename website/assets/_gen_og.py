...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.24.1  {mid}  TRACKER TRAY FIX"
    ...
    lines = [
        ...
        f"Matches sync after tray restore.",
        f"My Stats never goes stale again.",
    ...
    draw.text((70, H - 40), "v0.24.1  ·  Windows + macOS", font=small_font, fill=MUTED)
