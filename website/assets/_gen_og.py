...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.9  {mid}  SHAREABLE DECKLISTS"
    ...
    lines = [
        "Publish a deck, share one link",
        "Viewers copy the list straight into Arena",
    ...
    draw.text((70, H - 40), "v3.1.9  ·  Windows + macOS", font=small_font, fill=MUTED)
