...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.9.5  {mid}  AETHERFIELD"
    ...
    lines = [
        "All of Reality Fracture, fully spoiled",
        "118,276 cards as one explorable galaxy",
    ...
    draw.text((70, H - 40), "v3.9.5  ·  Win + macOS + Linux", font=small_font, fill=MUTED)
