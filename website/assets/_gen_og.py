...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.0.1  {mid}  FASTER & HONEST"
    ...
    lines = [
        "Snappier everywhere — a hidden render loop, gone",
        "Status page when an Arena update breaks tracking",
    ...
    draw.text((70, H - 40), "v3.0.1  ·  Windows + macOS", font=small_font, fill=MUTED)
