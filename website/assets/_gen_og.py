...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.21  {mid}  B&R ALERTS + ROTATION IMPACT"
    ...
    lines = [
        ...
        f"Instant B&R alerts {mid} rotation impact per deck.",
        f"Climb streaks {mid} season-vs-season.",
    ...
    draw.text((70, H - 40), "v0.21.0  ·  Windows + macOS", font=small_font, fill=MUTED)
