...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.4  {mid}  HOW MANY OF EACH"
    ...
    lines = [
        "Revealed cards now show how many of each",
        "Copy the list with counts and rebuild their 75",
    ...
    draw.text((70, H - 40), "v3.1.4  ·  Windows + macOS", font=small_font, fill=MUTED)
