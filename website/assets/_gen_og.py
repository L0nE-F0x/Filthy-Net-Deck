...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.0  {mid}  SNAPPY AGAIN"
    ...
    lines = [
        "Instant page switching, however long your history",
        "New-set cards with real art from day one",
    ...
    draw.text((70, H - 40), "v3.1.0  ·  Windows + macOS", font=small_font, fill=MUTED)
