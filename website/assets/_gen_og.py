...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.7.0  {mid}  SHARE MATCHUPS + OVERLAY WR"
    ...
    lines = [
        "Share matchups to Discord or X.",
        "Overlay: historical WR vs the archetype",
        "you're facing. First-session coach.",
    ...
    draw.text((70, H - 40), "v1.7.0  ·  Windows + macOS", font=small_font, fill=MUTED)
