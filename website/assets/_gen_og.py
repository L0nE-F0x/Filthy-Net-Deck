...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.4.2  {mid}  YOUR MYTHIC CLIMB, ACTUALLY CURVED"
    ...
    lines = [
        "Post-match rank path draws the real curve.",
        "Match-end alerts land over fullscreen Arena.",
        "Updates install only through the signed updater.",
    ...
    draw.text((70, H - 40), "v2.4.2  ·  Windows + macOS", font=small_font, fill=MUTED)
