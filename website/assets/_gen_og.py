...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.6.0  {mid}  OPPONENT ARCHETYPE INFERENCE"
    ...
    lines = [
        "Know the deck across the table —",
        "your winrate vs each meta archetype.",
        "Bo3 sideboard analytics · real MTGO lists.",
    ...
    draw.text((70, H - 40), "v1.6.0  ·  Windows + macOS", font=small_font, fill=MUTED)
