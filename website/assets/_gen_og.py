...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.19  {mid}  FORMAT HUB + DECKLISTS"
    ...
    lines = [
        ...
        f"Format hub {mid} rotation dates {mid} ban lists.",
        f"Your decklists {mid} one-click copy {mid} fullscreen.",
    ...
    draw.text((70, H - 40), "v0.19.0  ·  Windows + macOS", font=small_font, fill=MUTED)
