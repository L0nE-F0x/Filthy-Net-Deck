...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.6.3  {mid}  OVERLAY REMEMBERS SIZE"
    ...
    lines = [
        "Overlay size & mode stick across matches and restarts",
        "Bo3 sideboard tab · ranked vs unranked stays honest",
    ...
    draw.text((70, H - 40), "v2.6.3  ·  Windows + macOS", font=small_font, fill=MUTED)
