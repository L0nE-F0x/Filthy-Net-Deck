...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.8.2  {mid}  AETHERFIELD"
    ...
    lines = [
        "117,621 cards as one explorable galaxy",
        "Real volumetric nebulae, lit from the core",
    ...
    draw.text((70, H - 40), "v3.8.2  ·  Win + macOS + Linux", font=small_font, fill=MUTED)
