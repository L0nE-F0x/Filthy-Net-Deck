...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.2  {mid}  CARDS THEY REVEALED"
    ...
    lines = [
        ...
        "Copy the list and rebuild their deck — stays local",
    ...
    draw.text((70, H - 40), "v3.1.2  ·  Windows + macOS", font=small_font, fill=MUTED)
