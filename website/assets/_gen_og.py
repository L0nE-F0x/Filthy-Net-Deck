...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.20  {mid}  CLIMB TRACKER GLOW-UP"
    ...
    lines = [
        ...
        f"Smooth rank curve {mid} peak marker {mid} hover detail.",
        f"Fullscreen tray controls {mid} one instance.",
    ...
    draw.text((70, H - 40), "v0.20.0  ·  Windows + macOS", font=small_font, fill=MUTED)
