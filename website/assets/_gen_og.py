...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.7.2  {mid}  SNAPPIER UI"
    ...
    lines = [
        "Snappier navigation — pages prefetch, no full remount",
        "Fixed post-boot re-render loop · leaner card art",
    ...
    draw.text((70, H - 40), "v2.7.2  ·  Windows + macOS", font=small_font, fill=MUTED)
