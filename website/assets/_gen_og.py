...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v2.7.5  {mid}  TRACKING WATCHDOG"
    ...
    lines = [
        "Opt in to help catch broken tracking fast",
        "Instant page switching · faster search",
    ...
    draw.text((70, H - 40), "v2.7.5  ·  Windows + macOS", font=small_font, fill=MUTED)
