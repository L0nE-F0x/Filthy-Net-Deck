...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.23  {mid}  LIGHT MODE + ARENA FIX + TRAILERS"
    ...
    lines = [
        ...
        f"Light mode {mid} Arena // import fix.",
        f"Official WotC set trailers in-app.",
    ...
    draw.text((70, H - 40), "v0.23.0  ·  Windows + macOS", font=small_font, fill=MUTED)
