...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.4.0  {mid}  BELLS & WHISTLES"
    ...
    lines = [
        ...
        "Share deck cards · hardened overlay.",
        "Opt-in soft sound · rank-up moments.",
    ...
    draw.text((70, H - 40), "v1.4.0  ·  Windows + macOS", font=small_font, fill=MUTED)
