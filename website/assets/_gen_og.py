...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.7  {mid}  JACE KAITO TEZZERET"
    ...
    lines = [
        "Jace, Kaito & Tezzeret join Themes",
        "Indigo, neon night, and etherium brass",
    ...
    draw.text((70, H - 40), "v3.1.7  ·  Windows + macOS", font=small_font, fill=MUTED)
