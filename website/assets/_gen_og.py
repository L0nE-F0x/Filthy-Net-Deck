...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v0.14  {mid}  SPOILER PULSE"
    ...
    lines = [
        ...
        f"Spoiler pulse {mid} Std/Pio legality {mid} filters.",
    ...
    draw.text((70, H - 40), "v0.14.0  ·  Windows + macOS", font=small_font, fill=MUTED)
