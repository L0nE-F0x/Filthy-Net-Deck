...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v3.1.6  {mid}  TODAY STATS"
    ...
    lines = [
        "Today chip on My Stats — last 24 hours",
        "WR, decks, and history scoped to today",
    ...
    draw.text((70, H - 40), "v3.1.6  ·  Windows + macOS", font=small_font, fill=MUTED)
