...
def main() -> None:
    ...
    badge_text = f"NEW  {mid}  v1.3  {mid}  IN-GAME OVERLAY"
    ...
    lines = [
        ...
        "In-game overlay: art, draw odds, lands.",
        "Slim collapsible HUD · resize + snap.",
    ...
    draw.text((70, H - 40), "v1.3.0  ·  Windows + macOS", font=small_font, fill=MUTED)
