...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            toast::toast_show,
            toast::toast_pending,
            toast::toast_move_mode,
            toast::toast_layer_geometry,
            toast::toast_set_margins,
            toast::toast_save_geometry,
            toast::toast_reset_position,
            presence::presence_set_enabled,
            presence::presence_is_enabled,
            presence::presence_set_size,
            presence::presence_layer_geometry,
            presence::presence_set_margins,
            presence::presence_save_geometry,
            presence::presence_get_geometry,
